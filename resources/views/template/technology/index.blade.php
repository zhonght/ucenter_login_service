...
<body class="hold-transition login-page"
      style="background: url({{ config('wj_ucenter_login_service.login_bg_img')?:admin_asset("vendor/weigather/wj_ucenter_login_service/template/".config('wj_ucenter_login_service.template')."/img/bg_jpg@2x.png") }}) center center no-repeat;background-size: cover;">


<div class="login-box" style="background: url({{admin_asset("vendor/weigather/wj_ucenter_login_service/template/".config('wj_ucenter_login_service.template')."/img/kuang_b@2x.png")}}) center center no-repeat;background-size: 100% 100%;">
